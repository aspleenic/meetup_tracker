...
get '/docker' do
  api_result = RestClient.get 'http://api.meetup.com/groups.json/?&topic=docker&order=members&key=682d733452163d471f4656620674a53'
  jhash = JSON.parse(api_result)
  counter = jhash['results'].count
  output = ''
...
get '/go' do
  api_result = RestClient.get 'http://api.meetup.com/groups.json/?&topic=go&order=members&key=682d733452163d471f4656620674a53'
  jhash = JSON.parse(api_result)
  counter = jhash['results'].count
  output = ''
